...
namespace BlogWebApplication.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Category category,IFormFile? Image, bool cbResimSil) /*buraya bir bak ?var, işe yaradı artık image yüklemek zorunda değisin editlerken*/
        {
            if (id != category.Id)
            {
                return NotFound();
